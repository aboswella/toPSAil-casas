...
% H2/CO2 activated-carbon surrogate. They are not Yang source constants.
    ...
    addParameter(parser, "NativeValveCoefficient", 1e-6, @(x) isnumeric(x) && ...
...
function params = ensureRuntimeDesignDefaults(params, opts)
    ...
    params.yangRuntimeDefaults = struct( ...
        ...
        "nativeValveBasis", "commissioning_design_default_not_source", ...
...
function params = ensureRuntimeBoundaryDefaults(params, nativeValveCoefficient)
    ...
    params.valFeedColNorm = nativeValveCoefficient * params.valScaleFac * ...
        ones(params.nCols, params.nSteps);
    params.valProdColNorm = nativeValveCoefficient * params.valScaleFac * ...
        ones(params.nCols, params.nSteps);
