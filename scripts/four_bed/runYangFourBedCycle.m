...
function adapterConfig = makeAdapterConfig(group, controls, opts)
    ...
    switch string(group.operationFamily)
        case "PP_PU"
            ...
            adapterConfig.PP_PU_wasteCouplingPolicy = controls.PP_PU_wasteCouplingPolicy;
            adapterConfig.PP_PU_wasteCouplingAlpha = controls.PP_PU_wasteCouplingAlpha;
        case "ADPP_BF"
            ...
            if ~isempty(controls.ADPP_BF_externalProductPressureRatio)
                adapterConfig.externalProductPressureRatio = ...
                    controls.ADPP_BF_externalProductPressureRatio;
                adapterConfig.externalProductPressureBasis = ...
                    "controls.ADPP_BF_externalProductPressureRatio";
            end
        otherwise
