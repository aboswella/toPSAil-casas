...
% metadata or dump full state histories in compact mode.
    ...
    report.flowReport = struct( ...
        "native", report.flows, ...
        "moles", struct("unitBasis", "physical_moles_using_params.nScaleFac", ...
            "externalFeedByComponent", [1; 0.1], ...
            "externalProductByComponent", [0.5; 0.01], ...
            "internalTransferOutByComponent", [0.2; 0.02], ...
            "internalTransferInByComponent", [0.2; 0.02]));
    ...
    report.terminalPhysicalStateChecksums = struct( ...
        "local_1", struct("nValues", 12, "sum", 2.1, "norm", 1.0), ...
        "local_2", struct("nValues", 12, "sum", 2.2, "norm", 1.1));
    ...
    assert(contains(txt, "terminalPhysicalStateChecksums"));
    assert(contains(txt, "surrogateFlags"));
    assert(contains(txt, "physical_moles"));
